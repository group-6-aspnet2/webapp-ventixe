    ...
    <>
      <div key={event.eventId} className="event-card">
        <div className="event-card-header">
          <EventCategoryButton>{event.eventCategoryName}</EventCategoryButton>
        ...
        <div className="event-card-footer">
          <CreateBookingButton onClick={() => setShowModal(true)}>
            Book
          </CreateBookingButton>
        </div>
      </div>
      ...
      {showModal && (
        <BookingModalLayout
          ...
          onSuccess={() => {
            setSuccessMessage(`Booking to ${event.eventName} is completed!`);
          }}
        />
      )}
    </>
